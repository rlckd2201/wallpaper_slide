...
- The admin image list now has a delete button for each image. Deleting an image removes the physical server file and also removes matching slide entries from `policy.json`.
